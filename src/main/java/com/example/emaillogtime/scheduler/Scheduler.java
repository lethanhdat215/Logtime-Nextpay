...
//    @Bean
    @Scheduled(cron = "0 0 11 ? * MON-FRI") // */15 * * * * * // 0 0 17 ? * MON-FRI -> 17h thu 2 - thu 6 send mail
...
//    @Bean
    @Scheduled(cron = "0 0 11 ? * MON-FRI") //*/30 * * * * * // 0 0 11 ? * SAT -> send mail vao luc 11h thu 7 hang tuan
